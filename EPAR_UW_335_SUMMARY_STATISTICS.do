...
global directory 				"SET FILE PATH"

*Set directories

*ETHIOPIA
global Ethiopia_ESS_W3_final_data					"$directory/Ethiopia ESS/Ethiopia ESS/Wave 3" 
...
global Ethiopia_ESS_W2_final_data					"$directory/Ethiopia ESS/Ethiopia ESS/Wave 2"
...
global Ethiopia_ESS_W1_final_data					"$directory/Ethiopia ESS/Ethiopia ESS/Wave 1"
...
*TANZANIA
global Tanzania_NPS_W4_final_data  					"$directory/Tanzania NPS/Tanzania NPS/Wave 4"
...
global Tanzania_NPS_W3_final_data  					"$directory/Tanzania NPS/Tanzania NPS/Wave 3"
...
global Tanzania_NPS_W2_final_data  					"$directory/Tanzania NPS/Tanzania NPS/Wave 2"
...
global Tanzania_NPS_W1_final_data  					"$directory/Tanzania NPS/Tanzania NPS/Wave 1"
...
*NIGERIA
global Nigeria_GHS_W3_final_data  					"$directory/Nigeria GHS/Nigeria GHS/Wave 3"
...
global Nigeria_GHS_W2_final_data  					"$directory/Nigeria GHS/Nigeria GHS/Wave 2"
global Nigeria_GHS_W2_exchange_rate 199.04975		// https://www.bloomberg.com/quote/USDETB:CUR
global Nigeria_GHS_W2_gdp_ppp_dollar 93.915			// https://data.worldbank.org/indicator/PA.NUS.PPP
global Nigeria_GHS_W2_cons_ppp_dollar 123.639		// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global Nigeria_GHS_W2_inflation 0.362927552			// inflation rate 2013-2016. Data was collected during 2012-2013. We want to ajhust value to 2016

global Nigeria_GHS_W1_final_data  					"$directory/Nigeria GHS/Nigeria GHS/Wave 1"
...
global list_instruments /*
*/ Ethiopia_ESS_W3 Ethiopia_ESS_W2 Ethiopia_ESS_W1 /*
*/ Nigeria_GHS_W3 Nigeria_GHS_W2 Nigeria_GHS_W1 /*
*/ Tanzania_NPS_W4 Tanzania_NPS_W3 Tanzania_NPS_W2 Tanzania_NPS_W1
...
foreach instrument of global list_instruments {
	...
	** Group 4  - yields 
	...
	if "`instrument'"!="BurkinaF_EMC_W1" { //no livestock households in Burkina Faso 
	...
	*Explicit cost by farm type
	...
	foreach v of global final_indicator8 {
		foreach i in 1ppp 2ppp loc {
			qui tabstat w_cost_expli_ha_`v'_`i' w_cost_expli_ha_`v'01Ha_`i' w_cost_expli_ha_`v'12Ha_`i' w_cost_expli_ha_`v'24Ha_`i' w_cost_expli_ha_`v'4Ha_`i'  [aw=w_ha_planted_weight]   if rural==1 & ag_hh==1, stat(mean sd p25 p50 p75  min max N) col(stat) save
	...
	* Rural poverty headcount
	...
	qui findname poverty_under_1_9,  all(@==.) local (missing_var)
	if "`missing_var'"!="" { 
		qui replace poverty_under_1_9=0
	}	
	local missing_var ""			
	...
	foreach v in poverty_under_1_9 {
